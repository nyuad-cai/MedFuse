...
# from mimic3models.pytorch_models.lstm import Trainer
# from mimic3models.pytorch_models.lstm import LSTM_PYTORCH
...
parser.add_argument('--data', type=str, help='Path to the data of decompensation task',
                    default='../med_fuse/data/mimic-iv-extracted/decompensation')
...
if args.mode == 'train':
    ...
    # import torch
    # generator_output = next(train_data_gen)
    # # lstm_p = LSTM_PYTORCH()
    # xx = torch.from_numpy(generator_output[0])
    # xx_out = lstm_p(xx.float())
    # trainer.train()
...
# python -um mimic3models.decompensation.main --network mimic3models/keras_models/lstm.py --dim 128 --timestep 1.0 --depth 1 --mode train --batch_size 8 --output_dir mimic3models/decompensation_iv
